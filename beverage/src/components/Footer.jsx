...
//   return (
//     <footer style={{ borderTop: '1px solid rgba(255,255,255,0.07)', background: '#151318', paddingTop: '70px' }}>
...
//           </div>
//           <Link to="/menu" style={{
//             background: 'var(--hot-pink)', color: 'white', padding: '14px 32px',
...
//         {/* Main grid */}
//         <div className="footer-main-grid" style={{ gap: '50px', marginBottom: '60px' }}>
...
//             {/* Email */}
//             <a
//               href="mailto:ayushsinghtomar184@gmail.com"
//               style={{
...
//         {/* Mini stats bar */}
//         <div className="footer-stats-bar" style={{
//           display: 'flex', gap: '0',
